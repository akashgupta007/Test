...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Asset/CreateCategory.js") %>"></script>
 ...
 <form id="CreateCategory" novalidate="novalidate">
                    ...
                    <div id="DetailPanel" class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"> </h3>
                             <span  style="text-align:left;"class="panel-title" >Asset Category  </span>                           
                        ...
                        <div  class="panel-body ">
                             ...
                             <div class="form-group">
                               ...
                               Category Description
                                ...
                                <div class="Form-control col-lg-9 ">
                                       <%: Html.TextBoxFor(model => model.CategoryDesc , new {@class="form-control", placeholder="Enter Description "})%>
                                    <%: Html.ValidationMessageFor(model => model.CategoryDesc)%>
