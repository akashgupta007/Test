<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PoiseERP.Areas.Payroll.Models.AssetModelViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Asset/CreateModel.js") %>"></script>
 ...
 <form id="CreateModel" novalidate="novalidate">
                    ...
                    <div id="DetailPanel" class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"> </h3>
                             <span  style="text-align:left;"class="panel-title" >Asset Model  </span>                           
                        ...
                        <div  class="panel-body ">
                              ...
                              Model Name
                                ...
                                <div class="Form-control col-lg-9 ">
                                      ...
                                      <%:Html.TextBoxFor(model => model.ModelName , new {@class="form-control", placeholder="Enter category Name "})%>
                            ...
                            <div class="form-group" >
                             ...
                             <div class="form-group">
                               ...
                               Model Description
                                ...
                                <div class="Form-control col-lg-9 ">
                                       <%: Html.TextBoxFor(model => model.ModelDesc , new {@class="form-control", placeholder="Enter Description "})%>
                                    <%: Html.ValidationMessageFor(model => model.ModelDesc)%>
