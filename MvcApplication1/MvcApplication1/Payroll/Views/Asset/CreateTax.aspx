<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PoiseERP.Areas.Payroll.Models.TaxViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Asset/createtax.js") %>"></script>
 ...
 <form id="CreateTax" novalidate="novalidate">
                        ...
                        <div  class="panel-body ">
                              ...
                              Tax Name
                                ...
                                <div class="Form-control col-lg-9 ">
                                      ...
                                      <%:Html.TextBoxFor(model => model.TaxDesc , new {@class="form-control", placeholder="Enter category Name "})%>
                                    <%: Html.ValidationMessageFor(model => model.TaxDesc)%>
                                </div>
                            </div>
                             <div class="form-group">
                                <div class="col-lg-3 ">
                               Tax Percentage
                                ...
                                <div class="Form-control col-lg-9 ">
                                       <%: Html.TextBoxFor(model => model.taxpercent , new {@class="form-control", placeholder="Enter Description "})%>
