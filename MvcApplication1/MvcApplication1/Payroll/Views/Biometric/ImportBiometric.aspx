...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Biometric/ImportBiometric.js") %>"></script>
    ...
    <form method="post" id="ImportBiometric" novalidate="novalidate" enctype="multipart/form-data">
        <div class="row">

            <div id="DetailPanel" class="panel panel-primary">

                <div class="panel-heading">
                    <h3 class="panel-title">Import Biometric</h3>
                </div>
            ...
            <%: Html.DropDownListFor(model => model.EmployeeId ,Model.EmployeeList, new {@class="form-control"})%>
                    ...
                    <div class="col-lg-12" style="margin-top: 5px;">
                           <div class="col-lg-2">
                        <button type="submit" id="btnDownload" name="command" value="DownloadExcelFormat" class="btn  btn-success"><span class="glyphicon glyphicon-download"></span> Download Excel</button>
                       </div>
