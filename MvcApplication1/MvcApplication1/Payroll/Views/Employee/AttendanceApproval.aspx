...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Employee/AttendanceApproval.js") %>"></script>
                    ...
                    <div class="col-lg-12">
                        <div id="DetailPanel" class="panel panel-primary">
                            ...
                            <div class="panel-heading">                                  
                             <a style="color: #E6F1F3;float:right" target="_blank" href="<%= Url.Content("~/Help/Payroll/Employee/AttendanceApproval.html") %>  ">
