    ...
    <% Ajax.BeginForm(ajaxOptions); %>
                    ...
                    <div class="col-lg-12">
                        <div id="DetailPanel" class="panel panel-primary">
                            ...
                            <div class="panel-heading">
                                <span  style="text-align:left;"class="panel-title" >Employee Arrear Process</span>
       ...
       <div class="col-lg-12">
        ...
        <div class="col-lg-2">
                                 ...
                                 <%: Html.DropDownListFor(model => model.PayrollArrearItemId ,Model.PayrollArearItemList, new {@class="form-control"})%>
                                    <%: Html.ValidationMessageFor(model => model.PayrollArrearItemId)%>
                                </div>
             ...
             <div class="col-lg-1">
                                  Arrear Month  
                                    ...
                                    <%: Html.DropDownListFor(model => model.ArearMonthId ,Model.ArearMonthList, new {@class="form-control"})%>
                                    <%: Html.ValidationMessageFor(model => model.ArearMonthId)%>
                                </div>
