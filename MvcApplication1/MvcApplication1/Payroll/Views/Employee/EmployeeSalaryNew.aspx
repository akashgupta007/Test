<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PoiseERP.Areas.Payroll.Models.EmpSalaryNewViewModel>" %>
<%--<%@ Control Inherits="System.Web.Mvc.ViewPage<IEnumerable<Product>>" %>--%>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Employee/EmployeeSalaryNew.js") %>"></script>
    ...
    <style>
        .panel childrow td{column-span:all;
        }
    </style>
                    ...
                    <div id="DetailPanel" class="panel panel-primary">
                        ...
                        <div class="panel-body ">
                            ...
                            <div class="panel panel-primary" id="EditPanel" style="display: none;">
                                ...
                                <div class="panel-body ">
                                    <div class="col-lg-12">
                                        <div class="form-group col-lg-2" id="IsCTCDiv" style="margin-left: 1px;">
                                            ...
                                            <%--   <%: Html.RadioButtonFor(model => model.IsCTC,"GrossCTC", new {@class="ctcgross", @checked="true" })%> Using Gross/CTC
                                            --%>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                 ...
                                 <%: Html.TextBoxFor(model => model.EndDt, new {@class="form-control DBPicker Parent", @readonly="readonly", placeholder="End Date"})%>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-offset-4 col-lg-3">
                                            ...
                                            <img id="loading" style="display: none;" src="<%= Url.Content("~/Images/processing_image.gif") %> " />
                                        </div>
                                ...
                                <div class="panel-body ">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td colspan="9">
                                                <div class="form-group">
                                                    <button type='submit' id='insert' value='Insert'  name='command' class='btn btn-success '><span class='glyphicon glyphicon-picture'></span> SaveAll</ button>
                                                    ...
                                                    <img id="ChildLoading" style="display: none;" src="<%= Url.Content("~/Images/processing_image.gif") %> " />
                                                </div>
    ...
    <div class="LodingE" style="display: none;">
        <div id="popup" class="popup">
            <div class="content">
                <img id="LoadingProgressExcel" src="<%= Url.Content("~/Images/processing_image.gif") %> " />
            </div>
        </div>
    </div>
