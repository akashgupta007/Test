...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Employee Surrender Leave Request
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form id="EmployeeSurrenderLeaveRequest" novalidate="novalidate">
    <div class="form-horizontal" style="margin-top:5px;">
          <div class="row">                 
             <div class="col-lg-12">
                    <div class="panel panel-primary"   id="leaves" >
                        <div class="panel-heading">
                               <h3 class="panel-title">Employee Surrender Leave Request</h3>
                        </div>
             ...
             <div class="col-lg-12">
                    <div class="panel panel-primary" id="EditPanel" style="display: none;">
                        <div class="panel-heading">
                            <h3 class="panel-title"><span id="panelHeader">Edit Employee Surrender Leave Request</span></h3>
                        </div>
                        <div  class="panel-body " >                                                                                                                                                                                                                                                                                                                              
