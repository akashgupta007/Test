<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PoiseERP.Areas.Payroll.Models.EmpTypeViewModel>" %>
...
<script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Master/EmployeeType.js") %>"></script>
    ...
    <form id="EmployeeType" novalidate="novalidate">
                ...
                <div class="col-lg-6">
                    ...
                    <div id="DetailPanel" class="panel panel-primary">
                        <div class="panel-heading">
                              ...
                              <span  style="text-align:left;"class="panel-title" >Employee Type  </span>                            
                            <span style=" float:right; vertical-align:top" ><a style="background-color: #337ab7; color: #E6F1F3;" target="_blank" href="<%= Url.Content("~/Help/Payroll/Master/EmployeeType.html") %>">
                        ...
                        <div  class="panel-body ">
                             ...
                             <div class="form-group">
                                ...
                                <div class="Form-control col-lg-9 ">
                                    <input type="hidden" id="EmpTypeId" name="EmpTypeId" />
                                    <%: Html.TextBoxFor(model => model.EmpTypeDesc , new {@class="form-control", placeholder="Enter Employee Type"})%>
                                    <%: Html.ValidationMessageFor(model => model.EmpTypeDesc)%>
                                </div>
                            </div>                             
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="col-lg-3 ">
                                 ...
                                 <div class="Form-control col-lg-9 ">
                                     <%: Html.DropDownListFor(model => model.WorkUnit ,Model.WorkUnitList, new {@class="form-control"})%>
                               
                                    <%: Html.ValidationMessageFor(model => model.WorkUnit)%>
                             ...
                             <div class="form-group">
                                <div class="col-lg-3 ">
                                 ...
                                 <div class="Form-control col-lg-9 ">
                                    <%: Html.TextBoxFor(model => model.WorkUnitValue , new {@class="form-control", placeholder="Enter Value"})%>
                                    <%: Html.ValidationMessageFor(model => model.WorkUnitValue)%>
                                </div>
                            </div>
