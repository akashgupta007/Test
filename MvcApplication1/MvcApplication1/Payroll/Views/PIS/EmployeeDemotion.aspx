...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/PIS/EmployeeDemotion1.js") %>"></script>
   ...
   <script type="text/javascript">
    ...
    <form id="EmployeeDemotionDetails" method="post" novalidate="novalidate">
                ...
                <div class="col-lg-6">
                    ...
                    <div id="DetailPanel" class="panel panel-primary">
                        <div class="panel-heading">
                            <span  style="text-align:left;"class="panel-title" > Employee Demotion  </span>                          

                         <span style=" float:right; vertical-align:top" ><a style="background-color: #337ab7; color: #E6F1F3;" target="_blank" href="<%= Url.Content("~/Help/Payroll/PIS/EmployeeDemotion.html") %>"><b> <img  src="<%= Url.Content("~/Images/HelpImage.PNG") %> " /></b></a>   </span>
                        ...
                        <div class="panel-body ">
                            ...
                            <div class="form-group">
                                <div class="col-md-3">
                                    <button type="button" id="newEntity" name="newEntity" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span>Employee Demotion   </button>
                                </div>
                        ...
                        <div  class="panel-body ">
                            ...
                            <div class="form-group">
                                <div class="col-lg-3 ">
                                 ...
                                 <div class="Form-control col-lg-9 ">
                                     <%: Html.TextBoxFor(model => model.PromoDemoFromDate  , new { @class = "form-control DBPicker ", @readonly="readonly", placeholder = "Enter   Demoted From " })%>
