<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PoiseERP.Areas.Payroll.Models.HraRangeViewModel>" %>
...
<script src="<%=Url.Content("~/Scripts/ViewScript/Payroll/Leave/HRARange.js") %>"></script>
...
<form id="HRARange" novalidate="novalidate">
    <div class="form-horizontal" style="margin-top:10px;">
          <div class="row">
                <div class="col-lg-6">
                    <div id="DetailPanel" class="panel panel-primary">
                        <div class="panel-heading">
                           <%-- <h3 class="panel-title">HRA Range Details  </h3>--%>
                   
                             <span  style="text-align:left;"class="panel-title" >HRA Range Defined   </span>
                            <span style=" float:right; vertical-align:top" ><a style="background-color: #337ab7; color: #E6F1F3;" target="_blank" href="<%= Url.Content("~/Help/Payroll/Payroll/HRARange.html") %>">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary" id="EditPanel" style="display: none;">
                        ...
                        <div  class="panel-body ">         
                            ...
                            <div class="form-group"> 
                                 <div class="col-lg-3"> HRA 
                                 </div>                                
                                     <div class="Form-control col-lg-9">
                                                  <%: Html.TextBoxFor(model => model.Hra, new {@class="form-control", placeholder="Enter HRA "})%>
