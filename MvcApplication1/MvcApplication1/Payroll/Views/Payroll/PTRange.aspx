<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PoiseERP.Areas.Payroll.Models.PTRangeViewModel>" %>
...
<script src="<%=Url.Content("~/Scripts/ViewScript/Payroll/Payroll/PTRange1.js") %>"></script>
...
<form id="PTRange" novalidate="novalidate">
    <div class="form-horizontal" style="margin-top:10px;">
          <div class="row">
                <div class="col-lg-6">
                    <div id="DetailPanel" class="panel panel-primary">
                        <div class="panel-heading">
                             <span  style="text-align:left;"class="panel-title"> PT Range Defined  </span>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-primary" id="EditPanel" style="display: none;">
                        ...
                        <div  class="panel-body ">  
                              <div class="form-group"> 
                                 <div class="col-lg-3"> Start Range 
                                 </div>                                
                               ...
                               <div class="form-group"> 
                                 <div class="col-lg-3"> Minimum
                                     ...
                                     <div class="Form-control col-lg-9"> 
                                         ...
                                         <%: Html.TextBoxFor(model => model.StartRange, new {@class="form-control", placeholder="Enter Min Range "})%>
                                     <%: Html.ValidationMessageFor(model => model.StartRange)%>
                                              </div>                                                             
                                            </div>                                
                               <div class="form-group"> 
                                 <div class="col-lg-3"> Maximum
                                     ...
                                     <div class="Form-control col-lg-9">
                                                  <%: Html.TextBoxFor(model => model.EndRange, new {@class="form-control", placeholder="Enter Max Range "})%>
                                     <%: Html.ValidationMessageFor(model => model.EndRange)%>                                  
                                              </div>                                                             
                                            </div>  
                            <div class="form-group"> 
                                 <div class="col-lg-3"> Professional Tax 
                                 </div>                                
                                     <div class="Form-control col-lg-9">
                                                  <%: Html.TextBoxFor(model => model.ProfessionTax, new {@class="form-control", placeholder="Enter PT "})%>
                                     <%: Html.ValidationMessageFor(model => model.ProfessionTax)%>                            
                                              </div>                                                             
                                            </div>                                                                                                                                       
                            <div class="form-group">
