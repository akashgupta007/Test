<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<PoiseERP.Areas.Payroll.Models.PayrollTaxViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="<%=Url.Content("~/Scripts/ViewScript/Payroll/Payroll/PayrollTax.js") %>"></script>
    ...
    <form id="PayrollTax" novalidate="novalidate">
    <div class="form-horizontal" style="margin-top:10px;">
          <div class="row">
                <div class="col-lg-6">
                    <div id="DetailPanel" class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Payroll Tax Details  </h3>
                        </div>
                        ...
                        <div  class="panel-body ">                                                                                                                                     
                               <div class="form-group"> 
                                 <div class="col-lg-3"> Payroll Tax
                                     ...
                                     <div class="Form-control col-lg-9"> 
                                           <input type="hidden" id="PayrollTaxId" name="PayrollTaxId" />
                                         <%: Html.TextBoxFor(model => model.PayrollTaxDescription, new {@class="form-control", placeholder="Enter Payroll Tax"})%>
                                     <%: Html.ValidationMessageFor(model => model.PayrollTaxDescription)%>
                                              </div>                                                             
                                            </div>                              
                               ...
                               <div class="form-group"> 
                                 <div class="col-lg-3">Payroll Tax Type 
                                     ...
                                     <div class="Form-control col-lg-9">
                                   <%: Html.DropDownListFor(model => model.PayrollTaxTypeId ,Model.PayrollTaxTypeList, new {@class="form-control"})%>                           
                                              </div>                                                             
                                            </div>
                            <div class="form-group"> 
                                 <div class="col-lg-3">Tax Function
                                 </div>                                
                                     <div class="Form-control col-lg-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="Form-control col-lg-9">
                                    <%: Html.RadioButtonFor(model => model.TaxableEntity, "EE",  new { @id="teEE", @checked = "checked" })%>Employee &nbsp;
                                    <%: Html.RadioButtonFor(model => model.TaxableEntity, "ER", new { @id="teER" })  %>Employer  
                                </div>
                            </div>

                             <div class="form-group"> 
                                 <div class="col-lg-3">Employee Type 
                                 </div>                                
                                     <div class="Form-control col-lg-9">
