<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<PoiseERP.Areas.Payroll.Models.EmpSalaryViewModel>" %>
    ...
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Employee/EmployeeCenterEmpGroupSalary.js") %>"></script>
<script>
                    ...
                    <div id="DetailPanel" class="panel panel-primary">
                        ...
                        <div class="panel-body ">
                            ...
                            <div class="col-lg-12" style="margin-top: 20px;">
                                ...
                                <button style="margin-bottom: 2px; margin-right: 1px; display: none;" type="submit" id="btnExcel" class="btn  btn-success enabling cancel" name="command" value="Excel">Excel</button>
                                <button style="margin-bottom: 2px; margin-right: 1px; display: none;" type="submit" id="btnWord" class="btn  btn-success enabling cancel" name="command" value="Word">Word</button>
                            </div>
                        </div>
                    </div>
                </div>
