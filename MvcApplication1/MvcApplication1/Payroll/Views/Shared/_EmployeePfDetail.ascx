<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<PoiseERP.Models.PayrollReportViewModel>" %>
    ...
    <script src="<%= Url.Content("~/Scripts/ViewScript/Payroll/Employee/EmployeeCenterPfDetail.js") %>"></script> 
<%--<script src="../../../../Scripts/ViewScript/Payroll/Employee/EmployeeCenterPfDetail.js"></script>--%>
<script>
            ...
            <div class="col-lg-12">
                <div id="DetailPanel" class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Employee PF Details</h3>
                    </div>
                    ...
                    <br />
                       <%-- <button style="margin-bottom: 2px; margin-right: 1px; display:none;" type="submit" id="btnPdf" class="btn  btn-success enabling cancel" name="command" value="Pdf">Pdf</button>
