...
function RowDelete(BannerId) {
    try {
        ...
        $.post("MainBannerDelete", form.serialize(),
           function (response) {
...
function MainBannerGet() {
    try {
        $("#MsgDiv").removeAttr("class");
        $("#lblError").html("");
        $("#MsgDiv").hide();

        $.post("MainBannerGet", function (response) {
    ...
    $("#btnInsert").click(
        ...
        function (e) {
            try {
                ...
                $.post("MainBannerInsert", form.serialize(),
                    function (response) {
                        if (response.Flag == 0) {  //Successfully
                            $("#data").html("");
                            $("#data").html(response.Html);
    ...
    $("#btnInsert").click(
        ...
        function (e) {
            try {
                ...
                $.post("MainBannerUpdate", form.serialize(),
                    function (response) {
                        if (response.Flag == 0) {  //Successfully
                            $("#data").html("");
                            $("#data").html(response.Html);
